...
quality_controls() {
	...
	# BAMQC
	qualimap bamqc -bam ${1}_father.bam -outdir ./../QC/${1}_father
	qualimap bamqc -bam ${1}_child.bam -outdir ./../QC/${1}_child
	qualimap bamqc -bam ${1}_mother.bam -outdir ./../QC/${1}_mother
